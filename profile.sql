...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2023 at 10:44 AM
...
INSERT INTO `backup` (`pid`, `date`, `amount`, `uid`, `g_id`) VALUES
('1', '10/10/23', 100, 'achu123', '1111'),
('2', '20/2/22', 200, 'achu123', '1111'),
('4', '10/10/23', 100, 'a123', '1111'),
('5', '20/2/22', 200, 'a123', '1111');
...
(1111, 'MS GYM', 'Manoj', 1234567893, 'Cherpulassery', '10:00 am', '8:00 pm');
...
INSERT INTO `payment` (`pid`, `date`, `amount`, `p_user_id`, `p_gym_id`) VALUES
(3, '30/10/23', 300, 'achu123', 1111),
(7, '30/10/23', 300, 'a123', 1111);
...
('a123', 'ajay', 12345, 'a@123', 'a123', 103),
('achu123', 'achu', 123456, 'achu@gmail.com', 'achu123', 101);
